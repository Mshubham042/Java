...
@MultipartConfig( location="C:\\Users\\admin\\Documents\\NetBeansProjects\\fileupload\\web\\image\\prodimg"
   // 100 MB
)
...
//                    out.println("Form Variable Name:" + p.getName() + "<br/>");
              ...
              db.connect();
              String qry = "insert into product values(0,'"+ pro_cate+"','"+pro_title+"','"+pro_price+"','"+pro_decs+"','"+pro_color+"','"+fname+"')";
